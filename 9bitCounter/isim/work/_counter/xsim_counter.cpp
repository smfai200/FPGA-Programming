...
public:
    ...
    HSimConfigDecl * topModuleInstantiate() {
        ...
        (*cfgvh).addVlogModule("Counter", (HSimInstFactoryPtr)IF0);
        (*cfgvh).addVlogModule("glbl", (HSimInstFactoryPtr)IF1);
        HSim__s5 * topvl = 0;
        topvl = new workM_counter("Counter");
